...
import static com.vondear.rxtools.RxFileTool.delAllFile;
...
public class FileUtils {
     ...
     * @param schoolId
     */
    public static void delFaceFile(String schoolId) {
        File fileName = FileUtils.isFileExist(FileUtils.getBatchImportDirectory().getPath(), schoolId);
        if (!Preconditions.isNullOrEmpty(fileName) && !Preconditions.isNullOrEmpty(fileName.getPath())) {
            FileUtils.delFolder(fileName.getPath());
        }
    }
