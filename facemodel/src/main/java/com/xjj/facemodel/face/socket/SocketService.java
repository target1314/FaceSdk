package com.xjj.facemodel.face.socket;
...
import com.xjj.facemodel.face.manager.RecordLogManager;
import com.xjj.facemodel.face.model.BaseConfig;
...
import com.xjj.facemodel.face.socket.socketmodel.request.CleanLog;
import com.xjj.facemodel.face.socket.socketmodel.request.DeleteRecords;
import com.xjj.facemodel.face.socket.socketmodel.request.GetGroupList;
import com.xjj.facemodel.face.socket.socketmodel.request.GetRecords;
import com.xjj.facemodel.face.socket.socketmodel.request.GetUserInfo;
import com.xjj.facemodel.face.socket.socketmodel.request.GetUserList;
import com.xjj.facemodel.face.socket.socketmodel.request.GroupAdd;
import com.xjj.facemodel.face.socket.socketmodel.request.GroupDelete;
import com.xjj.facemodel.face.socket.socketmodel.request.RecordList;
import com.xjj.facemodel.face.socket.socketmodel.request.UserAdd;
import com.xjj.facemodel.face.socket.socketmodel.request.UserCopy;
import com.xjj.facemodel.face.socket.socketmodel.request.UserDelete;
import com.xjj.facemodel.face.socket.socketmodel.request.UserUpdate;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponeseUnKonwError;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseAddAndUpdate;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseCleanLog;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseDeleteRecords;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseDevice;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseGetGroupList;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseGetRecords;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseGetUserInfo;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseGetUserList;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseGroupAdd;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseGroupDelete;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseResetConfigFile;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseUserCopy;
import com.xjj.facemodel.face.socket.socketmodel.response.ResponseUserDelete;
import com.xjj.facemodel.face.utils.BitmapUtils;
import com.xjj.facemodel.face.utils.ConfigUtils;
import com.xjj.facemodel.face.utils.FileUtils;
import com.xjj.facemodel.face.utils.ImageUtils;
    ...
    public void choiceMessage(String messsage) {
        ...
        try {
            ...
            if (code == RequestConfig.resetConfigFile) {
                ...
                SingleBaseConfig.copyInstance((BaseConfig) socketResult.getData());
                try {
...
//                            userUpdate.getUserName(), userUpdate.getImageName(), faceBytes);
                    isSuccess = FaceApi.getInstance().userUpdate(userUpdate.getUserName(),
                            userUpdate.getImageName(), faceBytes);
                }
            ...
            if (code == RequestConfig.userDelete) {
                ...
                isSuccess = FaceApi.getInstance().userDeleteByName(userDelete.getUserName());
                if (isSuccess) {
                    result = "SUCCESS";
                } else {
                    result = "Fail";
...
//                        .getUserListByUserName(userCopy.getSrcGroupId(), userCopy.getUserName());
                List<User> listUser = FaceApi.getInstance()
                        .getUserListByUserName(userCopy.getUserName());
...
//                        , getUserInfo.getUserName());
                List<User> list = FaceApi.getInstance().getUserListByUserName(getUserInfo.getUserName());
                if (list.size() > 0) {
                    result = "SUCCESS";
